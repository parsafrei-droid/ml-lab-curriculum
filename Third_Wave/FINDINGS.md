...
```bash
git clone https://github.com/borawhocodess/modded-nanotabpfn Third_Wave/modded-nanotabpfn
cd Third_Wave/modded-nanotabpfn && git apply ../modded_feature_curriculum.patch
