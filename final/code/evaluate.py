...
# Three metrics because they catch different things: ROC-AUC is about ranking, log-loss
# about calibration, balanced accuracy about per-class recall.
...
# We also split by binary and multiclass, so we can check a result is not just an
# artefact of which datasets happened to be scored.
